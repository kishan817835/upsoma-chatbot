        ...
        widgetContainer.innerHTML = `
            <div class="ai-chat-container">
                ...
                <button class="ai-chat-toggle-btn" id="aiChatToggle">
                    <img src="https://upsoma-chatbot-31e1.vercel.app/chatbot_img.png" alt="Chat Bot" style="height:110px;">
                ...
                <div class="ai-chat-window" id="aiChatWindow">
                    ...
                    <div class="ai-chat-header">
                        <div class="ai-header-content">
                            <h3><img src="https://upsoma-chatbot-31e1.vercel.app/chatbubble.png" alt="AI" style="height:20px; width:20px; margin-right:8px; vertical-align:middle;">${config.title}</h3>
                        ...
                        <div class="ai-message ai-bot-message">
                            <div class="ai-message-content">
                                <div class="ai-sender-name">
                                    <strong><img src="https://upsoma-chatbot-31e1.vercel.app/chatbubble.png" alt="AI" style="height:16px; width:16px; margin-right:5px; vertical-align:middle;"> ${config.title}</strong>
                                </div>
...
.ai-chat-container {
    ...
    border: 1px solid #rgb(145 180 83);
    animation: ai-glow 1.8s infinite;
    border-radius:50%;
...
@keyframes ai-glow {
    0% {
        box-shadow: 0 0 10px rgba(205, 22, 22, 0.4);
    }
    50% {
        box-shadow: 0 0 24px rgba(207, 30, 30, 0.9);
    }
    100% {
    ...
    function addMessage(text, sender) {
        ...
        messageDiv.innerHTML = `
            <div class="ai-message-content">
                <div class="ai-sender-name">
                    <strong>${sender === 'user' ? '👤 You' : `<img src="https://upsoma-chatbot-31e1.vercel.app/chatbubble.png" alt="AI" style="height:16px; width:16px; margin-right:5px; vertical-align:middle;"> ${config.title}`}</strong>
                </div>
    ...
    function initWidget() {
        ...
        if (window.AI_CHAT_CONFIG) {
            config = Object.assign(config, window.AI_CHAT_CONFIG);
        }
